...
//	var latest = rpc.LatestBlockHeight
//	results, err := api.CallMany(context.Background(), json.RawMessage("[]"), &rpc.BlockHeightOrHash{BlockHeight: &latest})
//	if err != nil {
...
//	[{"from":"0x71562b71999873db5b286df957af199ec94617f7","to":"0x0d3ab14bbad3d99f4203bd7a11acb94882050e7e","gas":"0x15f90","gasPrice":"0x4a817c800","value":"0x1"},["trace", "stateDiff"]]
//]
//`), &rpc.BlockHeightOrHash{BlockNumber: &latest})
//	if err != nil {
//		t.Errorf("calling CallMany: %v", err)
//	}
//	if results == nil {
...
//	v := addrDiff.Balance.(map[string]*common.Big)["+"].ToInt().Uint64()
...
//	// Call GetTransactionReceipt for transaction which is not in the database
//	n := rpc.BlockHeight(6)
//	results, err := api.ReplayBlockTransactions(context.Background(), rpc.BlockHeightOrHash{BlockHeight: &n}, []string{"stateDiff"})
//	if err != nil {
