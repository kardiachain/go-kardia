...
type BlockHeaderWeb3JSON struct {
...
func NewPublicWeb3API(kaiService *KardiaService) *PublicKaiAPI {
	return &PublicKaiAPI{kaiService}
}

// NewBlockHeaderJSON creates a new BlockHeader JSON data from Block
func NewBlockHeaderWeb3JSON(header *types.Header, blockInfo *types.BlockInfo) *BlockHeaderJSON {
	if header == nil {
		return nil
	}
...
func NewBlockWeb3JSON(block *types.Block, blockInfo *types.BlockInfo) *BlockJSON {
	if block == nil {
		return nil
	}
...
func (s *PublicWeb3API) BlockNumber() uint64 {
	return s.kaiService.blockchain.CurrentBlock().Height()
}

// GetBlockHeaderByNumber returns blockHeader by block height
func (s *PublicWeb3API) GetBlockHeaderByNumber(ctx context.Context, blockHeight rpc.BlockHeight) *BlockHeaderJSON {
...
func (s *PublicWeb3API) GetBlockHeaderByHash(ctx context.Context, blockHash rpc.BlockHeightOrHash) *BlockHeaderJSON {
...
func (s *PublicWeb3API) GetBlockByNumber(ctx context.Context, blockHeight rpc.BlockHeight) *BlockJSON {
...
func (s *PublicWeb3API) GetBlockByHash(ctx context.Context, blockHash rpc.BlockHeightOrHash) *BlockJSON {
...
type PublicTransactionWeb3 struct {
...
func (a *PublicWeb3API) GetBalance(ctx context.Context, address common.Address, blockHeightOrHash rpc.BlockHeightOrHash) (string, error) {
...
func (a *PublicWeb3API) Nonce(address string) (uint64, error) {
...
func (a *PublicWeb3API) NonceAtHeight(ctx context.Context, address common.Address, blockHeightOrHash rpc.BlockHeightOrHash) (uint64, error) {
...
func (a *PublicWeb3API) GetCode(ctx context.Context, address common.Address, blockHeightOrHash rpc.BlockHeightOrHash) (common.Bytes, error) {
	state, _, err := a.kaiService.StateAndHeaderByHeightOrHash(ctx, blockHeightOrHash)
	if state == nil || err != nil {
		return nil, err
	}
...
func (a *PublicWeb3API) GetStorageAt(ctx context.Context, address common.Address, key string, blockHeightOrHash rpc.BlockHeightOrHash) (common.Bytes, error) {
	state, _, err := a.kaiService.StateAndHeaderByHeightOrHash(ctx, blockHeightOrHash)
	if state == nil || err != nil {
		return nil, err
	}
...
func (s *PublicWeb3API) doCall(ctx context.Context, args types.CallArgsJSON, blockHeightOrHash rpc.BlockHeightOrHash, vmCfg kvm.Config, timeout time.Duration) (*kvm.ExecutionResult, error) {
...
func (s *PublicWeb3API) GasPrice(ctx context.Context) (string, error) {
...
func (s *PublicWeb3API) EstimateGas(ctx context.Context, args types.CallArgsJSON, blockHeightOrHash rpc.BlockHeightOrHash) (uint64, error) {
