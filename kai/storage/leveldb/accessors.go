...
func CommonReadEventFromDualAction(db types.DatabaseReader, action string) (*common.Address, *abi.ABI) {
...
func CommonReadEvent(db types.DatabaseReader, address *common.Address, method string) *types.WatcherAction {
...
func CommonReadSmartContractAbi(db types.DatabaseReader, address *common.Address) *abi.ABI {
