...
func wipeSnapshot(db kaidb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db kaidb.KeyValueStore) error {
...
func wipeKeyRange(db kaidb.KeyValueStore, kind string, prefix []byte, keylen int) error {
