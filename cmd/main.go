...
func initFlag(args *flags) {
	flag.StringVar(&args.genesis, "genesis", "./cfg/genesis.yaml", "Path to genesis config file. Default: ./genesis.yaml")
	flag.StringVar(&args.kardia, "node", "./cfg/kai_config.yaml", "Path to Kardia node config file. Default: ./kai_config.yaml")
