...
import (
	...
	"github.com/kardiachain/go-kardia/internal/cmdtest"
	"github.com/kardiachain/go-kardia/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gkai-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gkai-test" in runGeth.
	reexec.Register("gkai-test", func() {
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gkai". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gkai-test", args...)
