...
// 	subscribeTimeout     = 5 * time.Second  // overall timeout kai_subscribe, rpc_modules calls
// )
...
// func (c *Client) KaiSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
