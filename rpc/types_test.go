...
func TestBlockHeightOrHash_UnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		8:  {`"latest"`, false, BlockHeightOrHashWithHeight(LatestBlockHeight)},
		9:  {`"earliest"`, false, BlockHeightOrHashWithHeight(EarliestBlockHeight)},
		...
		17: {`{"BlockHeight":1}`, false, BlockHeightOrHashWithHeight(1)},
		18: {`{"BlockHeight":"pending"}`, false, BlockHeightOrHashWithHeight(PendingBlockHeight)},
		19: {`{"BlockHeight":"latest"}`, false, BlockHeightOrHashWithHeight(LatestBlockHeight)},
		20: {`{"BlockHeight":"earliest"}`, false, BlockHeightOrHashWithHeight(EarliestBlockHeight)},
