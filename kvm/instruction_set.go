...
func newKardiaInstructionSet() JumpTable {
	return JumpTable{
		...
		ADD: {
			execute:     opAdd,
			constantGas: typesCfg.GasFastestStep,
			minStack:    minStack(2, 1),
			maxStack:    maxStack(2, 1),
		},
		MUL: {
			execute:     opMul,
			constantGas: typesCfg.GasFastStep,
			minStack:    minStack(2, 1),
			maxStack:    maxStack(2, 1),
		},
		SUB: {
		...
		ADDMOD: {
			execute:     opAddmod,
			constantGas: typesCfg.GasMidStep,
		...
		ADDRESS: {
			execute:     opAddress,
			constantGas: typesCfg.GasQuickStep,
		...
		BLOCKHASH: {
			execute:     opBlockhash,
			constantGas: typesCfg.GasExtStep,
			minStack:    minStack(1, 1),
			maxStack:    maxStack(1, 1),
		},
		COINBASE: {
		...
		JUMPI: {
			execute:     opJumpi,
			constantGas: typesCfg.GasSlowStep,
			minStack:    minStack(2, 0),
			maxStack:    maxStack(2, 0),
			jumps:       true,
		},
