...
var ballotSmcCode = common.Hex2Bytes("")
var ballotSmcDefinition = `[
	{
		"constant": true,
		"inputs": [
			{
...
func TestBallotSmcExecuteVote(t *testing.T) {
	...
	state.SetCode(address, ballotSmcCode)

	abi, err := abi.JSON(strings.NewReader(ballotSmcDefinition))
	if err != nil {
		t.Fatal(err)
	}
