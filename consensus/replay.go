	...
	case msgInfo:
		...
		case *ProposalMessage:
			...
			cs.Logger.Info("Replay: Proposal", "height", p.Height, "round", p.Round, "header",
				p.POLBlockID.PartsHeader, "pol", p.POLRound, "peer", peerID)
...
func (cs *ConsensusState) catchupReplay(csHeight uint64) error {
	...
	gr, found, err := cs.wal.SearchForEndHeight(int64(csHeight), &WALSearchOptions{IgnoreDataCorruptionErrors: true})
	if err != nil {
		return err
	}
	if gr != nil {
