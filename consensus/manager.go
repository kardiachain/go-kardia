...
func (ps *PeerState) getVoteBitArray(height uint64, round uint32, type_ byte) *cmn.BitArray {
...
func (ps *PeerState) setHasVote(height uint64, round uint32, type_ byte, index uint32) {
