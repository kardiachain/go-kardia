...
const ourPath = "github.com/kardiachain/go-kardia" // Path to our module
...
func ClientName(clientIdentifier string) string {
	...
	return fmt.Sprintf("%s/v%v/%v-%v/%v",
		...
		configs.VersionWithCommit(git.Commit, git.Date),
...
//
// If the package that is currently executing is a prefixed by our go-kardia
