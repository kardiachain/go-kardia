...
func (m *H128) Reset()         { *m = H128{} }
func (m *H128) String() string { return proto.CompactTextString(m) }
func (*H128) ProtoMessage()    {}
func (*H128) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{10}
}
func (m *H128) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H128) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H128.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H128) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H128.Merge(m, src)
}
func (m *H128) XXX_Size() int {
	return m.Size()
}
func (m *H128) XXX_DiscardUnknown() {
	xxx_messageInfo_H128.DiscardUnknown(m)
}

var xxx_messageInfo_H128 proto.InternalMessageInfo

func (m *H128) GetHi() uint64 {
	if m != nil {
		return m.Hi
	}
	return 0
...
func (m *H160) Reset()         { *m = H160{} }
func (m *H160) String() string { return proto.CompactTextString(m) }
func (*H160) ProtoMessage()    {}
func (*H160) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{11}
}
func (m *H160) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H160) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H160.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H160) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H160.Merge(m, src)
}
func (m *H160) XXX_Size() int {
	return m.Size()
}
func (m *H160) XXX_DiscardUnknown() {
	xxx_messageInfo_H160.DiscardUnknown(m)
}

var xxx_messageInfo_H160 proto.InternalMessageInfo

func (m *H160) GetHi() *H128 {
	if m != nil {
		return m.Hi
	}
	return nil
...
func (m *H256) Reset()         { *m = H256{} }
func (m *H256) String() string { return proto.CompactTextString(m) }
func (*H256) ProtoMessage()    {}
func (*H256) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{12}
}
func (m *H256) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H256) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H256.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H256) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H256.Merge(m, src)
}
func (m *H256) XXX_Size() int {
	return m.Size()
}
func (m *H256) XXX_DiscardUnknown() {
	xxx_messageInfo_H256.DiscardUnknown(m)
}

var xxx_messageInfo_H256 proto.InternalMessageInfo

func (m *H256) GetHi() *H128 {
	if m != nil {
		return m.Hi
	}
	return nil
...
func (m *H512) Reset()         { *m = H512{} }
func (m *H512) String() string { return proto.CompactTextString(m) }
func (*H512) ProtoMessage()    {}
func (*H512) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{13}
}
func (m *H512) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H512) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H512.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H512) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H512.Merge(m, src)
}
func (m *H512) XXX_Size() int {
	return m.Size()
}
func (m *H512) XXX_DiscardUnknown() {
	xxx_messageInfo_H512.DiscardUnknown(m)
}

var xxx_messageInfo_H512 proto.InternalMessageInfo

func (m *H512) GetHi() *H256 {
	if m != nil {
		return m.Hi
	}
	return nil
...
func (m *H1024) Reset()         { *m = H1024{} }
func (m *H1024) String() string { return proto.CompactTextString(m) }
func (*H1024) ProtoMessage()    {}
func (*H1024) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{14}
}
func (m *H1024) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H1024) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H1024.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H1024) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H1024.Merge(m, src)
}
func (m *H1024) XXX_Size() int {
	return m.Size()
}
func (m *H1024) XXX_DiscardUnknown() {
	xxx_messageInfo_H1024.DiscardUnknown(m)
}

var xxx_messageInfo_H1024 proto.InternalMessageInfo

func (m *H1024) GetHi() *H512 {
	if m != nil {
		return m.Hi
	}
	return nil
...
func (m *H2048) Reset()         { *m = H2048{} }
func (m *H2048) String() string { return proto.CompactTextString(m) }
func (*H2048) ProtoMessage()    {}
func (*H2048) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{15}
}
func (m *H2048) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *H2048) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_H2048.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *H2048) XXX_Merge(src proto.Message) {
	xxx_messageInfo_H2048.Merge(m, src)
}
func (m *H2048) XXX_Size() int {
	return m.Size()
}
func (m *H2048) XXX_DiscardUnknown() {
	xxx_messageInfo_H2048.DiscardUnknown(m)
}

var xxx_messageInfo_H2048 proto.InternalMessageInfo

func (m *H2048) GetHi() *H1024 {
	if m != nil {
		return m.Hi
	}
	return nil
...
func (*VersionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f03c926763cb388, []int{16}
}
...
func (m *VersionReply) GetMajor() uint32 {
	if m != nil {
		return m.Major
	}
	return 0
...
func (m *VersionReply) GetMinor() uint32 {
	if m != nil {
		return m.Minor
	}
	return 0
...
func (m *VersionReply) GetPatch() uint32 {
	if m != nil {
		return m.Patch
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*H128)(nil), "kardiachain.types.H128")
	proto.RegisterType((*H160)(nil), "kardiachain.types.H160")
	proto.RegisterType((*H256)(nil), "kardiachain.types.H256")
	proto.RegisterType((*H512)(nil), "kardiachain.types.H512")
	proto.RegisterType((*H1024)(nil), "kardiachain.types.H1024")
	proto.RegisterType((*H2048)(nil), "kardiachain.types.H2048")
	proto.RegisterType((*VersionReply)(nil), "kardiachain.types.VersionReply")
}
...
var fileDescriptor_6f03c926763cb388 = []byte{
	...
	,
}
...
func (m *H128) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H128) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H128) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *H160) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H160) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H160) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *H256) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H256) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H256) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *H512) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H512) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H512) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *H1024) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H1024) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H1024) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *H2048) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *H2048) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *H2048) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VersionReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Patch != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.Patch))
		i--
		dAtA[i] = 0x18
	}
	if m.Minor != 0 {
...
func (m *H128) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H128: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H128: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *H160) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H160: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H160: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *H256) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H256: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H256: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *H512) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H512: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H512: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *H1024) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H1024: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H1024: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *H2048) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: H2048: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: H2048: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
