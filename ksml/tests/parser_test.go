...
func TestStimulateDexReleaseEvent(t *testing.T) {
	...
	patterns := []string{
		...
		"${fn:var(convertedAmount,bigFloat,fn:mul(fn:div(convertedAmount,fn:float(fromAmount)),fn:float(toAmount)))}",
		"${fn:if(checkFromType,fromType == 'NEO')}",
		"${fn:var(convertedAmount,bigFloat,fn:mul(convertedAmount,fn:float(tenPoweredByTen)))}",
		"${fn:elif(checkFromType,fromType == 'TRX')}",
		"${fn:var(convertedAmount,bigFloat,fn:mul(convertedAmount,fn:float(tenPoweredByTwelve)))}",
		"${fn:else(checkFromType)}",
		"SIGNAL_STOP",
		"${fn:endif(checkFromType)}",
		"${fn:var(convertedAmount,bigInt,fn:int(fn:round(convertedAmount)))}",
		...
		"${fn:var(convertedAmount,bigInt,fn:div(fn:int(amounts[i]),tenPoweredByEight))}",
		"${fn:elif(checkFromType,fromType=='TRX')}",
		"${fn:var(convertedAmount,bigFloat,fn:float(amounts[i]))}",
		"${fn:var(convertedAmount,bigFloat,fn:mul(convertedAmount,fn:float(toAmount)))}",
		"${fn:var(convertedAmount,bigFloat,fn:div(convertedAmount,fn:float(fromAmount)))}",
		"${fn:var(convertedAmount,bigFloat,fn:div(convertedAmount,fn:float(tenPoweredBySix)))}",
		"${fn:var(convertedAmount,int64,fn:int(fn:round(convertedAmount)))}",
		"${fn:else(checkFromType)}",
		"SIGNAL_STOP",
		"${fn:endif(checkFromType)}",
...
func TestStimulateDexDepositETHEvent(t *testing.T) {
	...
	patterns := []string{
		...
		"${fn:var(convertedAmount,bigInt,fn:mul(fn:int(message.amount),fromAmount))}",
		"${fn:var(convertedAmount,bigInt,fn:div(convertedAmount,toAmount))}",
		"${fn:if(evaluateDestination,message.to=='NEO')}",
		"${fn:var(convertedAmount,bigInt,fn:div(convertedAmount,tenPoweredByTen))}",
		"${fn:elif(evaluateDestination,message.to=='TRX')}",
		"${fn:var(convertedAmount,bigInt,fn:div(convertedAmount,tenPoweredByTwelve))}",
