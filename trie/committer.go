...
func (c *committer) Commit(n node, db *TrieDatabase) (hashNode, error) {
	if db == nil {
...
// commit collapses a node down into a hash node and inserts it into the database
func (c *committer) commit(n node, db *TrieDatabase, force bool) (node, error) {
...
func (c *committer) commitChildren(n *fullNode, db *TrieDatabase, force bool) ([17]node, bool, error) {
...
func (c *committer) store(n node, db *TrieDatabase, force bool, hasVnodeChildren bool) node {
