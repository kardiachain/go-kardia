// Copyright 2022 The go-kardia Authors
...
import (
	...
	"github.com/kardiachain/go-kardia/trie/triedb/hashdb"
...
type Database struct {
	...
	diskdb    kaidb.Database   // Persistent database to store the snapshot
...
func prepare(diskdb kaidb.Database, config *Config) *Database {
...
func NewDatabase(diskdb kaidb.Database) *Database {
...
func NewDatabaseWithConfig(diskdb kaidb.Database, config *Config) *Database {
